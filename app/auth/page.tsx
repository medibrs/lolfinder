            ...
            <div className="flex justify-center lg:justify-end">
              <Card className="w-full max-w-sm lg:max-w-md bg-gray-900/90 backdrop-blur-sm border-purple-500/20 shadow-2xl max-h-[80vh] overflow-y-auto">
                <CardHeader className="space-y-1 text-center pb-4">
                  <CardTitle
                    className="text-xl lg:text-2xl font-bold text-white cursor-default select-none"
                ...
                <CardContent className="space-y-4 pb-6">
                  ...
                  <div className="flex flex-col gap-3">
                    <Button
                      ...
                      className="gap-2 w-full bg-black hover:bg-zinc-800 text-white border-zinc-700 h-12 text-base font-semibold"
                    >
                      <img src="https://upload.wikimedia.org/wikipedia/commons/8/8d/42_Logo.svg" alt="42 Logo" className="h-5 w-5 brightness-0 invert" />
                      Continue with 42
                    </Button>

                    <div className="mt-8 mb-4 border border-purple-500/30 bg-purple-900/10 rounded-xl p-4 text-center">
                      <p className="text-sm text-purple-200 font-medium mb-4">
                        We are currently hosting a closed 42 School tournament. Public login options will return after the event concludes.
                      </p>

                      <div className={`flex flex-col gap-3 ${!adminOverride ? 'opacity-50 grayscale pointer-events-none' : ''}`}>
                        <Button
                          variant="discord"
