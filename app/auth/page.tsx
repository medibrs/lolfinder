          ...
          <div className="flex flex-col lg:flex-row gap-12 items-center">
            ...
            <div className="w-full lg:w-1/2 space-y-8">
              <div className="space-y-6">
                <p className="text-slate-300 text-lg leading-relaxed font-beaufort">
                  Assemble your roster, dominate the bracket, and forge your legacy on the Rift.
                </p>

                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  <div className="flex items-center gap-4 p-4 bg-[#0c121d]/60 border border-slate-800/60 rounded-xl backdrop-blur-xl hover:border-cyan-500/50 transition-all duration-300">
                    <div className="flex-shrink-0">
                      <TeamsIcon size={24} className="text-cyan-400" />
                    </div>
                    <div>
                      <h3 className="text-white font-bold text-sm uppercase tracking-wider mb-1 font-beaufort">Scout Talent</h3>
                  ...
                  <div className="flex items-center gap-4 p-4 bg-[#0c121d]/60 border border-slate-800/60 rounded-xl backdrop-blur-xl hover:border-cyan-500/50 transition-all duration-300">
                    ...
                    <div>
                      <h3 className="text-white font-bold text-sm uppercase tracking-wider mb-1 font-beaufort">Enter The Bracket</h3>
                  ...
                  <div className="flex items-center gap-4 p-4 bg-[#0c121d]/60 border border-slate-800/60 rounded-xl backdrop-blur-xl hover:border-cyan-500/50 transition-all duration-300">
                    ...
                    <div>
                      <h3 className="text-white font-bold text-sm uppercase tracking-wider mb-1 font-beaufort">Analyze Matches</h3>
                  ...
                  <div className="flex items-center gap-4 p-4 bg-[#0c121d]/60 border border-slate-800/60 rounded-xl backdrop-blur-xl hover:border-cyan-500/50 transition-all duration-300">
                    ...
                    <div>
                      <h3 className="text-white font-bold text-sm uppercase tracking-wider mb-1 font-beaufort">Claim The Trophy</h3>
            ...
            <div className="w-full lg:w-1/2 flex justify-center">
              <div className="w-full max-w-sm bg-[#0c121d]/60 border border-slate-800/60 rounded-xl p-6 backdrop-blur-xl shadow-sm hover:shadow-[0_0_20px_rgba(6,182,212,0.1)] transition-all duration-300">
                <div className="space-y-2 text-center pb-4">
                  <h2
                    className="text-lg font-beaufort font-black text-white cursor-default select-none uppercase tracking-wider"
                    onClick={handleSecretClick}
                  >
                    {view === 'sign_in' ? 'Enter The Arena' : 'Summoner Signup'}
                  </h2>
                  <p className="text-slate-400 text-xs font-beaufort">
                    {view === 'sign_in'
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex flex-col gap-2">
                    <button
                      ...
                      className="gap-2 w-full bg-[#0c121d]/80 border border-slate-800/60 hover:border-cyan-500/50 hover:bg-cyan-500/5 text-white h-9 text-sm font-semibold font-beaufort uppercase tracking-normal rounded-md transition-all flex items-center justify-center"
                    >
                    ...
                    <div className="mt-6 mb-3 border border-slate-800/60 bg-[#0c121d]/40 rounded-xl p-3 text-center">
                      <p className="text-xs text-slate-300 font-beaufort font-bold mb-3">
                      ...
                      <div className={`flex flex-col gap-2 ${!adminOverride ? 'opacity-50 grayscale pointer-events-none' : ''}`}>
                        <button
                          ...
                          className="gap-2 w-full bg-[#5865F2] hover:bg-[#4752C4] text-white h-9 text-sm font-semibold font-beaufort uppercase tracking-normal rounded-md transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center"
                        >
                        ...
                        <button
                          ...
                          className="gap-2 w-full bg-white hover:bg-gray-100 text-black h-9 text-sm font-semibold font-beaufort uppercase tracking-normal rounded-md transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center"
                        >
                        ...
                        <button
                          ...
                          className="gap-2 w-full bg-[#0c121d]/80 border border-slate-800/60 hover:border-cyan-500/50 hover:bg-cyan-500/5 text-white h-9 text-sm font-semibold font-beaufort uppercase tracking-normal rounded-md transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center"
                        >
                          <svg className="h-4 w-4" viewBox="0 0 24 24" fill="currentColor">
                  ...
                  <p className="text-center text-xs text-slate-500 mt-4 font-beaufort">
